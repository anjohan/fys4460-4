    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \begin{luacode*}
                ...
                t0s = {}
                i = 0
                for line in io.lines("tmp/r2_t0s.dat") do
                    i = i + 1
                    t0s[i] = line
                end
                num_t0s = i
                xis = {}
                i = 0
                for line in io.lines("tmp/r2_xis.dat") do
                    i = i + 1
                    xis[i] = line
                    txt = "\\coordinate (" .. tostring(i) .. ") at (axis cs:"
                          .. t0s[i] .. ","
                          .. tostring(xis[i]*xis[i]) .. ");"
                    print(txt)
                    tex.sprint(txt)
                end
            \end{luacode*}
        ...
        \begin{luacode*}
            for i = 1, num_t0s do
                txt = "\\filldraw[gray] (" .. tostring(i) .. ") circle (0.05);"
                print(txt)
                tex.sprint(txt)
            end
        \end{luacode*}
